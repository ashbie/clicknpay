...
$id = $_POST['id'];
$result = mysqli_query($con,"SELECT * FROM `songs` WHERE `id`='$song_id'");
...
while($row = mysqli_fetch_assoc($result)){
	     ...
	     echo "<div class='col-lg-3 mt-4'>
              ...
              <div class='card-block'>
                <span class='pr-1'>Chanson:</span> <h4 class='card-title pl-2'>".$row['song']."</h4><br/><br/>
                <span class='pr-1'>Chanteur:</span> <div class='meta text-muted pl-1' style='display: inline;'><b>".$row['artist']."</b></div><br/><br/>
                <span class='pr-4'>Genre:</span> <div class='meta text-muted pl-1' style='display: inline;'><b>".$row['genre']."</b></div><br/><br/>
                <audio controls style='width:230px; height:40px;'><source src='clips/".$row['clip'] ."' type='audio/mpeg'> 
